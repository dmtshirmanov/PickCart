...
const templates: Array<ProductTemplate> = [
    ...
    },
    {
        ...
        category: "Смартфон",
        basePrice: 99,
        image: "https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-15-finish-select-202309-6-1inch-blue?wid=2000&hei=2000&fmt=jpeg&qlt=90&.v=1693009279823",
    },
    {
        name: "Sony WH-1000XM5",
        category: "Наушники",
        basePrice: 79,
        image: "https://sony.scene7.com/is/image/sonyglobalsolutions/wh-1000xm5_Primary_image?$primaryshotPreset$&fmt=png-alpha&wid=2000",
    },
    {
        name: "Apple Watch Series 9",
        category: "Умные часы",
        basePrice: 95,
        image: "https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/watch-s9-45mm-pink-sport-band-s9?wid=2000&hei=2000&fmt=jpeg&qlt=90&.v=1693304428668",
    },
    {
        name: "Dyson V15 Detect",
        category: "Пылесос",
        basePrice: 85,
        image: "https://dyson-h.assetsadobe2.com/is/image/content/dam/dyson/images/products/primary/447110-01.png",
    },
];

const brands = ["Apple", "Sony", "Samsung", "Dyson", "Xiaomi", "Huawei", "Bose", "JBL", "LG", "Philips"];
const modifiers = ["Pro", "Ultra", "Plus", "Max", "Mini", "Lite", "SE", "Elite", "Air", "Neo"];
const colors = ["Black", "White", "Blue", "Silver", "Gold", "Pink", "Green", "Graphite", "Titanium", "Red"];
...
function generateProductName(template: ProductTemplate, index: number, random: () => number): string {
